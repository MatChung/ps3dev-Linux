...
enum gt_types_enum {
 ...
 gt_ggc_e_19builtin_hash_struct, 
 gt_ggc_e_15toc_hash_struct, 
 ...
 gt_e_P19builtin_hash_struct4htab, 
 gt_e_P15toc_hash_struct4htab, 
...
#define gt_ggc_m_19builtin_hash_struct(X) do { \
  if (X != NULL) gt_ggc_mx_builtin_hash_struct (X);\
  } while (0)
extern void gt_ggc_mx_builtin_hash_struct (void *);
#define gt_ggc_m_15toc_hash_struct(X) do { \
  if (X != NULL) gt_ggc_mx_toc_hash_struct (X);\
  } while (0)
extern void gt_ggc_mx_toc_hash_struct (void *);
...
extern void gt_ggc_m_P19builtin_hash_struct4htab (void *);
extern void gt_ggc_m_P15toc_hash_struct4htab (void *);
...
#define gt_pch_n_19builtin_hash_struct(X) do { \
  if (X != NULL) gt_pch_nx_builtin_hash_struct (X);\
  } while (0)
extern void gt_pch_nx_builtin_hash_struct (void *);
#define gt_pch_n_15toc_hash_struct(X) do { \
  if (X != NULL) gt_pch_nx_toc_hash_struct (X);\
  } while (0)
extern void gt_pch_nx_toc_hash_struct (void *);
...
extern void gt_pch_n_P19builtin_hash_struct4htab (void *);
extern void gt_pch_n_P15toc_hash_struct4htab (void *);
...
extern void gt_pch_p_20lto_symtab_entry_def
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_19builtin_hash_struct
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_15toc_hash_struct
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_IP9tree_node12splay_tree_s
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_P19builtin_hash_struct4htab
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_P15toc_hash_struct4htab
    (void *, void *, gt_pointer_operator, void *);
