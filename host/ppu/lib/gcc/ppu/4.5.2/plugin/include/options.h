...
#define MASK_RELOCATABLE (1 << 24)
#define MASK_SOFT_FLOAT (1 << 25)
#define MASK_STRICT_ALIGN (1 << 26)
#define MASK_STRING (1 << 27)
#define MASK_VSX (1 << 28)
...
enum opt_code
{
  ...
  OPT_mabi_,                                 /* -mabi= */
  OPT_mads,                                  /* -mads */
  OPT_maix_struct_return,                    /* -maix-struct-return */
  OPT_malign_,                               /* -malign- */
  OPT_malign_branch_targets,                 /* -malign-branch-targets */
  OPT_mallow_df_permute,                     /* -mallow-df-permute */
  OPT_mallow_movmisalign,                    /* -mallow-movmisalign */
  OPT_maltivec,                              /* -maltivec */
  OPT_malways_hint,                          /* -malways-hint */
  OPT_mavoid_indexed_addresses,              /* -mavoid-indexed-addresses */
  OPT_mbig,                                  /* -mbig */
  OPT_mbig_endian,                           /* -mbig-endian */
  OPT_mbit_align,                            /* -mbit-align */
  OPT_mbit_word,                             /* -mbit-word */
  OPT_mbss_plt,                              /* -mbss-plt */
  OPT_mcall_,                                /* -mcall- */
  OPT_mcmpb,                                 /* -mcmpb */
  OPT_mcpu_,                                 /* -mcpu= */
  OPT_mdebug_,                               /* -mdebug= */
  ...
  OPT_meabi,                                 /* -meabi */
  OPT_memb,                                  /* -memb */
  OPT_mfloat_gprs_,                          /* -mfloat-gprs= */
  OPT_mfp_in_toc,                            /* -mfp-in-toc */
  OPT_mfprnd,                                /* -mfprnd */
  OPT_mfpu_,                                 /* -mfpu= */
  OPT_mfull_toc,                             /* -mfull-toc */
  OPT_mfused_madd,                           /* -mfused-madd */
  OPT_mgen_cell_microcode,                   /* -mgen-cell-microcode */
  OPT_mhard_dfp,                             /* -mhard-dfp */
  OPT_mhard_float,                           /* -mhard-float */
  OPT_minsert_sched_nops_,                   /* -minsert-sched-nops= */
  OPT_misel,                                 /* -misel */
  OPT_misel_,                                /* -misel= */
  OPT_mlittle,                               /* -mlittle */
  OPT_mlittle_endian,                        /* -mlittle-endian */
  OPT_mlong_double_,                         /* -mlong-double- */
  OPT_mlongcall,                             /* -mlongcall */
  OPT_mmfcrf,                                /* -mmfcrf */
  OPT_mmfpgpr,                               /* -mmfpgpr */
  OPT_mminimal_toc,                          /* -mminimal-toc */
  OPT_mmulhw,                                /* -mmulhw */
  OPT_mmultiple,                             /* -mmultiple */
  OPT_mmvme,                                 /* -mmvme */
  OPT_mnew_mnemonics,                        /* -mnew-mnemonics */
  OPT_mnewlib,                               /* -mnewlib */
  OPT_mno_fp_in_toc,                         /* -mno-fp-in-toc */
  OPT_mno_power,                             /* -mno-power */
  OPT_mno_powerpc,                           /* -mno-powerpc */
  OPT_mno_sum_in_toc,                        /* -mno-sum-in-toc */
  OPT_mno_toc,                               /* -mno-toc */
  OPT_mno_traceback,                         /* -mno-traceback */
  OPT_mno_update,                            /* -mno-update */
  OPT_mold_mnemonics,                        /* -mold-mnemonics */
  OPT_mpaired,                               /* -mpaired */
  OPT_mpopcntb,                              /* -mpopcntb */
  OPT_mpopcntd,                              /* -mpopcntd */
  OPT_mpower,                                /* -mpower */
  OPT_mpower2,                               /* -mpower2 */
  OPT_mpowerpc,                              /* -mpowerpc */
  OPT_mpowerpc_gfxopt,                       /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt,                        /* -mpowerpc-gpopt */
  OPT_mpowerpc64,                            /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_,         /* -mprioritize-restricted-insns= */
  OPT_mprototype,                            /* -mprototype */
  OPT_mrecip,                                /* -mrecip */
  OPT_mregnames,                             /* -mregnames */
  OPT_mrelocatable,                          /* -mrelocatable */
  OPT_mrelocatable_lib,                      /* -mrelocatable-lib */
  OPT_msched_costly_dep_,                    /* -msched-costly-dep= */
  OPT_msched_epilog,                         /* -msched-epilog */
  OPT_msched_groups,                         /* -msched-groups */
  OPT_msched_prolog,                         /* -msched-prolog */
  OPT_msdata,                                /* -msdata */
  OPT_msdata_,                               /* -msdata= */
  OPT_msecure_plt,                           /* -msecure-plt */
  OPT_mshlib,                                /* -mshlib */
  OPT_msim,                                  /* -msim */
  OPT_msimple_fpu,                           /* -msimple-fpu */
  OPT_msingle_float,                         /* -msingle-float */
  OPT_msoft_float,                           /* -msoft-float */
  OPT_mspe,                                  /* -mspe */
  OPT_mspe_,                                 /* -mspe= */
  OPT_mstrict_align,                         /* -mstrict-align */
  OPT_mstring,                               /* -mstring */
  OPT_msum_in_toc,                           /* -msum-in-toc */
  OPT_msvr4_struct_return,                   /* -msvr4-struct-return */
  OPT_mtls_markers,                          /* -mtls-markers */
  OPT_mtls_size_,                            /* -mtls-size= */
  OPT_mtoc,                                  /* -mtoc */
  OPT_mtraceback_,                           /* -mtraceback= */
  OPT_mtune_,                                /* -mtune= */
  OPT_mupdate,                               /* -mupdate */
  OPT_mvectorize_builtins,                   /* -mvectorize-builtins */
  OPT_mvrsave,                               /* -mvrsave */
  OPT_mvrsave_,                              /* -mvrsave= */
  OPT_mvsx,                                  /* -mvsx */
  OPT_mvsx_align_128,                        /* -mvsx-align-128 */
  OPT_mvsx_scalar_double,                    /* -mvsx-scalar-double */
  OPT_mvsx_scalar_memory,                    /* -mvsx-scalar-memory */
  OPT_mwarn_altivec_long,                    /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode,                  /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu,                           /* -mxilinx-fpu */
  OPT_mxl_compat,                            /* -mxl-compat */
  OPT_myellowknife,                          /* -myellowknife */
  OPT_nocpp,                                 /* -nocpp */
