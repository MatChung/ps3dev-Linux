...
extern const char *spu_arch_string;
extern int spu_branch_cost;
extern int spu_dual_nops;
extern int spu_ea_model;
extern const char *spu_fixed_range_string;
extern const char *spu_max_distance_str;
extern int spu_max_nops;
extern const char *spu_tune_string;
extern int pedantic;
...
#define MASK_ADDRESS_SPACE_CONVERSION (1 << 0)
#define MASK_BRANCH_HINTS (1 << 1)
#define MASK_ERROR_RELOC (1 << 2)
#define MASK_LARGE_MEM (1 << 3)
#define MASK_SAFE_DMA (1 << 4)
#define MASK_SAFE_HINTS (1 << 5)
#define MASK_STD_MAIN (1 << 6)
#define MASK_WARN_RELOC (1 << 7)

#define TARGET_ADDRESS_SPACE_CONVERSION ((target_flags & MASK_ADDRESS_SPACE_CONVERSION) != 0)
#define TARGET_BRANCH_HINTS ((target_flags & MASK_BRANCH_HINTS) != 0)
#define TARGET_ERROR_RELOC ((target_flags & MASK_ERROR_RELOC) != 0)
#define TARGET_LARGE_MEM ((target_flags & MASK_LARGE_MEM) != 0)
#define TARGET_SAFE_DMA ((target_flags & MASK_SAFE_DMA) != 0)
#define TARGET_SAFE_HINTS ((target_flags & MASK_SAFE_HINTS) != 0)
#define TARGET_STD_MAIN ((target_flags & MASK_STD_MAIN) != 0)
#define TARGET_WARN_RELOC ((target_flags & MASK_WARN_RELOC) != 0)
...
enum opt_code
{
  ...
  OPT_maddress_space_conversion,             /* -maddress-space-conversion */
  OPT_march_,                                /* -march= */
  OPT_matomic_updates,                       /* -matomic-updates */
  OPT_mbranch_cost_,                         /* -mbranch-cost= */
  OPT_mbranch_hints,                         /* -mbranch-hints */
  OPT_mcache_size_,                          /* -mcache-size= */
  OPT_mdual_nops,                            /* -mdual-nops */
  OPT_mdual_nops_,                           /* -mdual-nops= */
  OPT_mea32,                                 /* -mea32 */
  OPT_mea64,                                 /* -mea64 */
  OPT_merror_reloc,                          /* -merror-reloc */
  OPT_mfixed_range_,                         /* -mfixed-range= */
  OPT_mhint_max_distance_,                   /* -mhint-max-distance= */
  OPT_mhint_max_nops_,                       /* -mhint-max-nops= */
  OPT_mlarge_mem,                            /* -mlarge-mem */
  OPT_msafe_dma,                             /* -msafe-dma */
  OPT_msafe_hints,                           /* -msafe-hints */
  OPT_msmall_mem,                            /* -msmall-mem */
  OPT_mstdmain,                              /* -mstdmain */
  OPT_mtune_,                                /* -mtune= */
  OPT_munsafe_dma,                           /* -munsafe-dma */
  OPT_mwarn_reloc,                           /* -mwarn-reloc */
  OPT_nocpp,                                 /* -nocpp */
