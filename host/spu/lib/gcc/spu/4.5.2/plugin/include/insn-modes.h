/* Generated automatically from machmode.def and config/spu/spu-modes.def
   by genmodes.  */
...
enum machine_mode
{
  ...
  OImode,                  /* config/spu/spu-modes.def:29 */
  ...
  V2QImode,                /* config/spu/spu-modes.def:18 */
  V4QImode,                /* config/spu/spu-modes.def:19 */
  V2HImode,                /* config/spu/spu-modes.def:19 */
  V8QImode,                /* config/spu/spu-modes.def:20 */
  V4HImode,                /* config/spu/spu-modes.def:20 */
  V2SImode,                /* config/spu/spu-modes.def:20 */
  V16QImode,               /* config/spu/spu-modes.def:21 */
  V8HImode,                /* config/spu/spu-modes.def:21 */
  V4SImode,                /* config/spu/spu-modes.def:21 */
  V2DImode,                /* config/spu/spu-modes.def:21 */
  V2SFmode,                /* config/spu/spu-modes.def:24 */
  V4SFmode,                /* config/spu/spu-modes.def:25 */
  V2DFmode,                /* config/spu/spu-modes.def:25 */
  MAX_MACHINE_MODE,
